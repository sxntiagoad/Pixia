...
export const AWS_BUCKET_NAME = process.env.AWS_BUCKET_NAME ||  'sxntiago-pixia-aws';   
export const AWS_ACCESS_KEY = process.env.AWS_ACCESS_KEY|| 'AKIAVVZOOH4QRRK3E2BQ'; 
export const AWS_SECRET_KEY = process.env.AWS_SECRET_KEY || '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';
