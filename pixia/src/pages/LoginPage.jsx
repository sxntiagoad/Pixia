...
import fondoLogin from '../assets/fondo_login_register.jpg'; // Asegúrate de que la ruta sea correcta
...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-2/3 bg-cover bg-center" style={{ backgroundImage: `url(${fondoLogin})` }}>
      ...
      <div className='w-1/3 bg-zinc-900 flex items-center justify-end p-10'>
        <div className='bg-zinc-800 max-w-sm p-6 rounded-md'>
          <h1 className='text-white text-lg font-extrabold mb-2'>Login</h1>
          ...
          <p className="text-xs text-white flex gap-x-2 justify-center items-center mt-4">
